...
#ifdef WIN32
    CoInitialize(NULL);
    kinemic::KinemicEngine engine(options);
#else
    kinemic::KinemicEngine engine = (use_bglib) ? kinemic::KinemicEngine(options) : kinemic::KinemicEngine(std::make_shared<BleManagerBlePP>("hci0"));
#endif
